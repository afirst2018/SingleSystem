package com.chujiu.core.page.intercepts;
...
/**
 * 
 * @ClassName: PageIntercepts 
 * @Description: 分页拦截器 
 * @author chujiu
 * @date 2016年5月16日 上午11:16:20 
 *
 */
@Intercepts({@Signature(type = StatementHandler.class, method = "prepare", args = {Connection.class})})
public class PageIntercepts implements Interceptor {

	private static final Logger logger = LoggerFactory.getLogger(PageIntercepts.class);
