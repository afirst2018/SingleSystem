...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	protected void buildInitialFactories()  {
		...
		TextPaster randomPaster = new GlyphsPaster(Integer.valueOf(3), Integer.valueOf(3), new RandomListColorGenerator(new Color[] { new Color(23, 170, 27), new Color(220, 34, 11), new Color(23, 67, 172) }), new GlyphsVisitors[] { new TranslateGlyphsVerticalRandomVisitor(1.0D), new OverlapGlyphsUsingShapeVisitor(3.0D), new TranslateAllToRandomPointVisitor() });

		BackgroundGenerator back = new UniColorBackgroundGenerator(Integer.valueOf(200), Integer.valueOf(70), Color.white);

		FontGenerator shearedFont = new RandomFontGenerator(Integer.valueOf(80), Integer.valueOf(80), new Font[] { new Font("nyala", Font.BOLD, 20), new Font("nyala", Font.PLAIN, 20),  new Font("nyala", Font.BOLD, 20) }, false);
