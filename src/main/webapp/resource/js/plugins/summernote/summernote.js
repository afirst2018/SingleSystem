...
(function (factory) {
  ...
  var ImageDialog = function (context) {
     ...
     * @return {Promise}
     */
    this.showImageDialog = function () {//源码修改选择图片by 天赐
      /*return $.Deferred(function (deferred) {
      ...
      return $.Deferred(function (deferred) {
        BootstrapDialog.show({
          message: $('<div></div>').load(options.imageServerUrl),
          ...
          buttons: [{
            ...
            action: function(dialogItself){
              dialogItself.close();
              // imgServerBaseUrl 是在tg_template.html模板文件中定义的
              var img = $('<img src="' + imgServerBaseUrl +i_image_choose+'" />');
              context.invoke('editor.insertNode', img[0]);
              // editor.insertNode($editor, img[0]);
            }
          }, {
            label: ' 取消',
            cssClass: 'btn-white',
